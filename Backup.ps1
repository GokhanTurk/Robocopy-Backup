try {
    ...
    Function Backup-Folder {
        ...
        if ($confirm -eq "y") {
            robocopy "$sourcePath" "$destinationPath " /e /j /r:3 /w:5 /v /z /zb /tbd /np /compress /log+:$env:USERPROFILE\Desktop\Robocopy-Backup.log /xn /xo /xj /xjd /xjf /xf *.tmp /A-:SH /xf "pagefile.sys" /xd "${sourceDisk}System Volume Information" /xd "RECYCLER" /xd "Temporary Files" /xf "Config.Msi" /xd ${sourceDisk}'$RECYCLE.BIN"'
