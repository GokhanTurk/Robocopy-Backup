try {
    ...
    Function Backup-UserData {
        ...
        if ($confirm -eq "y") {
            robocopy "$sourcePath\Desktop\" "$destinationPath\Desktop"  /s /e /j /r:0 /w:0 /mt:$processorCoreCount /fp /eta /v /xn /xo /xj /xjd /xjf /xf *.tmp /A-:SH /tee /log+:$env:USERPROFILE\Desktop\Robocopy-Backup.log /xf "pagefile.sys" /xd "${sourceDisk}System Volume Information" /xd "RECYCLER" /xd "Temporary Files" /xf "Config.Msi" /xd ${sourceDisk}'$RECYCLE.BIN"'
            robocopy "$sourcePath\Downloads\" "$destinationPath\Downloads"  /s /e /s /e /j /mt:$processorCoreCount /r:0 /w:0 /mt:$processorCoreCount /fp /eta /v /xn /xo /xj /xjd /xjf /xf *.tmp /A-:SH /tee /log+:$env:USERPROFILE\Desktop\Robocopy-Backup.log /xf "pagefile.sys" /xd "${sourceDisk}System Volume Information" /xd "RECYCLER" /xd "Temporary Files" /xf "Config.Msi" /xd ${sourceDisk}'$RECYCLE.BIN"'
            robocopy "$sourcePath\Documents\" "$destinationPath\Documents"  /s /e /j /r:0 /w:0 /mt:$processorCoreCount /fp /eta /v /xn /xo /xj /xjd /xjf /xf *.tmp /A-:SH /tee /log+:$env:USERPROFILE\Desktop\Robocopy-Backup.log /xf "pagefile.sys" /xd "${sourceDisk}System Volume Information" /xd "RECYCLER" /xd "Temporary Files" /xf "Config.Msi" /xd ${sourceDisk}'$RECYCLE.BIN"'
            robocopy "$sourcePath\Pictures\" "$destinationPath\Pictures"  /s /e /j /r:0 /w:0 /mt:$processorCoreCount /fp /eta /v /xn /xo /xj /xjd /xjf /xf *.tmp /A-:SH /tee /log+:$env:USERPROFILE\Desktop\Robocopy-Backup.log /xf "pagefile.sys" /xd "${sourceDisk}System Volume Information" /xd "RECYCLER" /xd "Temporary Files" /xf "Config.Msi" /xd ${sourceDisk}'$RECYCLE.BIN"'
            robocopy "$sourcePath\Videos\" "$destinationPath\Videos"  /s /e /s /e /j /mt:$processorCoreCount /r:0 /w:0 /mt:$processorCoreCount /fp /eta /v /xn /xo /xj /xjd /xjf /xf *.tmp /A-:SH /tee /log+:$env:USERPROFILE\Desktop\Robocopy-Backup.log /xf "pagefile.sys" /xd "${sourceDisk}System Volume Information" /xd "RECYCLER" /xd "Temporary Files" /xf "Config.Msi" /xd ${sourceDisk}'$RECYCLE.BIN"'
            robocopy "$sourcePath\Music\" "$destinationPath\Music"  /s /e /j /r:0 /w:0 /mt:$processorCoreCount /fp /eta /v /xn /xo /xj /xjd /xjf /xf *.tmp /A-:SH /tee /log+:$env:USERPROFILE\Desktop\Robocopy-Backup.log /xf "pagefile.sys" /xd "${sourceDisk}System Volume Information" /xd "RECYCLER" /xd "Temporary Files" /xf "Config.Msi" /xd ${sourceDisk}'$RECYCLE.BIN"'
    ...
    Function Backup-Folder {
        ...
        if ($confirm -eq "y") {
            robocopy "$sourcePath" "$destinationPath " /e /j /r:3 /w:5 /v /z /zb /tbd /ndl /nfl /compress /log+:$env:USERPROFILE\Desktop\Robocopy-Backup.log /UNICODE /tee /xn /xo /xj /xjd /xjf /xf *.tmp /A-:SH /xf "pagefile.sys" /xd "${sourceDisk}System Volume Information" /xd "RECYCLER" /xd "Temporary Files" /xf "Config.Msi" /xd ${sourceDisk}'$RECYCLE.BIN"'
    ...
    Function Recover_UserData {
        ...
        if ($confirm -eq "y") {
            robocopy "$BackupFolder\Desktop\" "$destinationUser\Desktop"  /s /e /j /r:0 /w:0 /mt:$processorCoreCount /fp /eta /v /xn /xo /xj /xjd /xjf /xf *.tmp /A-:SH /tee /log+:$env:USERPROFILE\Desktop\Robocopy-Backup.log /xf "pagefile.sys" /xd "${sourceDisk}System Volume Information" /xd "RECYCLER" /xd "Temporary Files" /xf "Config.Msi" /xd ${sourceDisk}'$RECYCLE.BIN"'
            robocopy "$BackupFolder\Downloads\" "$destinationUser\Downloads"  /s /e /j /r:0 /w:0 /mt:$processorCoreCount /fp /eta /v /xn /xo /xj /xjd /xjf /xf *.tmp /A-:SH /tee /log+:$env:USERPROFILE\Desktop\Robocopy-Backup.log /xf "pagefile.sys" /xd "${sourceDisk}System Volume Information" /xd "RECYCLER" /xd "Temporary Files" /xf "Config.Msi" /xd ${sourceDisk}'$RECYCLE.BIN"'
            robocopy "$BackupFolder\Documents\" "$destinationUser\Documents"  /s /e /j /r:0 /w:0 /mt:$processorCoreCount /fp /eta /v /xn /xo /xj /xjd /xjf /xf *.tmp /A-:SH /tee /log+:$env:USERPROFILE\Desktop\Robocopy-Backup.log /xf "pagefile.sys" /xd "${sourceDisk}System Volume Information" /xd "RECYCLER" /xd "Temporary Files" /xf "Config.Msi" /xd ${sourceDisk}'$RECYCLE.BIN"'
            robocopy "$BackupFolder\Pictures\" "$destinationUser\Pictures"  /s /e /j /r:0 /w:0 /mt:$processorCoreCount /fp /eta /v /xn /xo /xj /xjd /xjf /xf *.tmp /A-:SH /tee /log+:$env:USERPROFILE\Desktop\Robocopy-Backup.log /xf "pagefile.sys" /xd "${sourceDisk}System Volume Information" /xd "RECYCLER" /xd "Temporary Files" /xf "Config.Msi" /xd ${sourceDisk}'$RECYCLE.BIN"'
            robocopy "$BackupFolder\Videos\" "$destinationUser\Videos"  /s /e /j /r:0 /w:0 /mt:$processorCoreCount /fp /eta /v /xn /xo /xj /xjd /xjf /xf *.tmp /A-:SH /tee /log+:$env:USERPROFILE\Desktop\Robocopy-Backup.log /xf "pagefile.sys" /xd "${sourceDisk}System Volume Information" /xd "RECYCLER" /xd "Temporary Files" /xf "Config.Msi" /xd ${sourceDisk}'$RECYCLE.BIN"'
            robocopy "$BackupFolder\Music\" "$destinationUser\Music"  /s /e /j /r:0 /w:0 /mt:$processorCoreCount /fp /eta /v /xn /xo /xj /xjd /xjf /xf *.tmp /A-:SH /tee /log+:$env:USERPROFILE\Desktop\Robocopy-Backup.log /xf "pagefile.sys" /xd "${sourceDisk}System Volume Information" /xd "RECYCLER" /xd "Temporary Files" /xf "Config.Msi" /xd ${sourceDisk}'$RECYCLE.BIN"'
